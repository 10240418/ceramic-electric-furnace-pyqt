...
class PageBatchCompare(QWidget):
    ...
    def init_ui(self):
        ...
        self.feed_weight_panel.setFixedHeight(400)
        ...
        layout.addWidget(self.feed_weight_panel)
        
        # 炉皮冷却水用量对比
        self.shell_water_panel = PanelTech("炉皮冷却水用量对比")
        self.shell_water_panel.setFixedHeight(400)
        ...
        layout.addWidget(self.shell_water_panel)
        
        # 炉盖冷却水用量对比
        self.cover_water_panel = PanelTech("炉盖冷却水用量对比")
        self.cover_water_panel.setFixedHeight(400)
        ...
        layout.addWidget(self.cover_water_panel)

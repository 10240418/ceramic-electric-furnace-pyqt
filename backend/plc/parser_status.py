...
class ModbusStatusParser:
    ...
    def __init__(self, config_path: str = None):
        ...
        """
        self.config_path = Path(config_path) if config_path else self.PROJECT_ROOT / "backend" / "configs" / "status_L3_P2_F2_C4_db30.yaml"
    ...
    def parse_status_module(self, data: bytes, offset: int) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f" 解析状态模块失败 @ offset {offset}: {e}")
            return {
                'done': False,
                'busy': False,
                'error': True,

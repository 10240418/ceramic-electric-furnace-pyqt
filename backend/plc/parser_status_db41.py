...
class DataStateParser:
    ...
    def __init__(self, config_path: str = None):
        ...
        """
        self.config_path = Path(config_path) if config_path else self.PROJECT_ROOT / "backend" / "configs" / "status_db41.yaml"
    ...
    def parse_status_module(self, data: bytes, offset: int) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f" 解析 DB41 状态模块失败 @ offset {offset}: {e}")
            return {
                'error': True,
                'status': 0xFFFF,
                'status_hex': "16#FFFF",
